...
function criarLista(){
    ...
    if (nomeLista != ''){ 	
		$.ajax({
            type: 'POST'
            , url: "http://192.168.1.102/Servidor/ListaDeProdutos.asmx/criarLista"
			, crossDomain:true
...
function editarNomeLista(){
    ...
    $.ajax({
        type: 'POST'
        , url: "http://192.168.1.102/Servidor/ListaDeProdutos.asmx/editarNomeLista"
		, crossDomain:true
        , contentType: 'application/json; charset=utf-8'
        , dataType: 'json'
...
function excluirLista(id){
	...
	if(confirme){
	   ...
	   $.ajax({
			type: 'POST'
			, url: "http://192.168.1.102/Servidor/ListaDeProdutos.asmx/removerLista"
			, crossDomain:true
			, contentType: 'application/json; charset=utf-8'
			, dataType: 'json'
...
function excluirProdutoDaLista(id){
   ...
   $.ajax({
        type: 'POST'
        , url: "http://192.168.1.102/Servidor/ListaDeProdutos.asmx/removerProdutoDaLista"
		, crossDomain:true
        , contentType: 'application/json; charset=utf-8'
        , dataType: 'json'
